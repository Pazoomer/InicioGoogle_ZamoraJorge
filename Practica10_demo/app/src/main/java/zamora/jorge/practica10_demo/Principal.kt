package zamora.jorge.practica10_demo
...
class Principal : AppCompatActivity() {
    object Global{
        var preferencias_compartidas="shared_preferences"
    }
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnLoginGoogle: Button = findViewById(R.id.btn_LoginGoogle) as Button
    ...
    fun verificar_sesion_abierta(){
        var session_abierta: SharedPreferences =this.getSharedPreferences(
            Global.preferencias_compartidas,
            Context.MODE_PRIVATE
        )
        var correo=session_abierta.getString("Correo","")
        var proveedor=session_abierta.getString("Proveedor","")
        if(correo!="" && proveedor!=""){
